...
def view (request):
		...
		return render(request, "cba_student_list.html", context)
		
class studentDetailView(DetailView):
	model = student
	
	template_name = "cba_student_detail.html"
...
class  subjectList(generic.ListView):
	def get(self, request): 
		...
		return render(request, "cba_professor.html", context)


class ProfessorDetailView(DetailView):
	model = professor
	
	template_name = "cba_professor_detail.html"
...
class SubjectDetailView(DetailView):
	model = subject
	template_name = "cba_subject_detail.html"
