    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Course', models.ManyToManyField(related_name='student', to='cba.Course')),
                ('grade', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='cba.Grade')),
            ],
        ),
        migrations.CreateModel(
            name='subject',
            fields=[
                ...
                ('Professor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='cba.professor')),
            ],
        ),
        migrations.AddField(
            model_name='grade',
            name='Subject',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='cba.subject'),
        ),
        migrations.AddField(
            model_name='attendancerecord',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cba.student'),
        ),
    ]
